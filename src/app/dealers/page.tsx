...
<div style={{width: '100%', maxWidth: '1440px', margin: '0 auto', boxSizing: 'border-box', display: 'flex', flexDirection: 'column'}}>
  ...
  <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: '56px 64px 48px 64px', background: 'linear-gradient(180deg,#f5f8fd 0%,#ffffff 100%)'}}>
    ...
    <div style={{display: 'flex', gap: '14px', marginTop: '32px'}}>
      <Link href="/dashboard/apply" style={{background: '#2563eb', color: '#ffffff', padding: '13px 26px', borderRadius: '999px', fontSize: '14px', fontWeight: '700'}}>Register your dealership &nbsp;→</Link>
      <Link href="#services" style={{border: '1px solid #cbd5e1', color: '#0f172a', padding: '13px 26px', borderRadius: '999px', fontSize: '14px', fontWeight: '700'}}>Explore our services</Link>
    </div>

    <div style={{display: 'flex', gap: '36px', marginTop: '40px', fontSize: '13px', color: '#334155', fontWeight: '500'}}>
  ...
  <div style={{display: 'grid', gridTemplateColumns: 'repeat(3,minmax(0,1fr))', gap: '40px', padding: '48px 64px', borderTop: '1px solid #e5e7eb'}}>
    <div>
  ...
  {/* big section */}
  <div id="services" style={{background: '#f5f8fd', padding: '72px 64px'}}>
    ...
    <div style={{fontSize: '34px', fontWeight: '800', marginTop: '12px', letterSpacing: '-0.01em'}}>You made the sale.<br /><span style={{color: '#2563eb'}}>We deliver it right.</span></div>
    ...
    <div style={{display: 'grid', gridTemplateColumns: 'repeat(3,minmax(0,1fr))', gap: '28px', marginTop: '44px'}}>
    ...
    <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: '#0b1220', borderRadius: '16px', padding: '28px 36px', marginTop: '44px'}}>
  ...
  <div style={{background: '#f5f8fd', padding: '72px 64px'}}>
    ...
    <div style={{fontSize: '32px', fontWeight: '800', marginTop: '12px', letterSpacing: '-0.01em'}}>Whatever needs moving.</div>

    <div style={{display: 'grid', gridTemplateColumns: 'repeat(4,minmax(0,1fr))', gap: '24px', marginTop: '36px'}}>
  ...
  <div style={{padding: '72px 64px', display: 'flex', justifyContent: 'space-between', gap: '64px', alignItems: 'center'}}>
    <div style={{maxWidth: '420px'}}>
      ...
      <div style={{fontSize: '32px', fontWeight: '800', marginTop: '12px', letterSpacing: '-0.01em'}}>Your first trip is a few steps away.</div>
    </div>
