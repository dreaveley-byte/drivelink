...
export default async function DriverPage() {
  ...
  const jobSelect = 'id, status, pickup_address, dropoff_address, recipient_name, customer_full_name, vehicle_year, vehicle_make, vehicle_model, stock_number, vin, is_trade_in_pickup, estimated_distance_km, estimated_driver_pay_cents, job_types(name), organizations(name)'
